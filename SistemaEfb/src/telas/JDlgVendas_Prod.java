...
public class JDlgVendas_Prod extends javax.swing.JDialog {
    ...
    VendasProdControle vendaProdCo;
    ...
    public JDlgVendas_Prod(java.awt.Frame parent, boolean modal) {
        ...
        List listarProduto;
        listarProduto = produtoDAO.listAll();
        for (int i = 0; i < listarProduto.size(); i++) {
            jCboProduto.addItem((ProdutoEfb) listarProduto.get(i));
        }
        jTxtTotal.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jCboProduto = new javax.swing.JComboBox<ProdutoEfb>();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        VendaProdutoEfb vendaProduto = new VendaProdutoEfb();
        produto = (ProdutoEfb) jCboProduto.getSelectedItem();
        vendaProduto.setProdutoEfb(produto);
        vendaProduto.setQuantidadeEfb(Integer.valueOf(jTxtQuantidade.getText()));
        vendaProduto.setValorUnitarioEfb(Double.parseDouble(jTxtValorUnitario.getText()));
        vendaProduto.setVendaEfb(jDlgVendas.venda);
        jDlgVendas.vendasProdControle.addList(vendaProduto);
        setVisible(false);
    ...
    private void jCboProdutoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jCboProdutoFocusLost
        // TODO add your handling code here:
        produto = new ProdutoEfb();
        produto = (ProdutoEfb) jCboProduto.getSelectedItem();
        jTxtValorUnitario.setText(String.valueOf(produto.getValorUnitarioEfb()));
        double total = Double.valueOf(jTxtValorUnitario.getText()) * Double.valueOf(jTxtQuantidade.getText());
    ...
    private javax.swing.JComboBox<ProdutoEfb> jCboProduto;
